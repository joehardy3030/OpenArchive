...
class ArchiveAPI: NSObject {
    ...
    func dateRangeURL(year: Int, month: Int, sbdOnly: Bool, collection: String = "GratefulDead") -> String {
        ...
        url += "fields=identifier,date,venue,transferer,source,coverage,stars,avg_rating,num_reviews,collection&"
        if sbdOnly {
    ...
    func searchTermURL(searchTerm: String?, venue: String?, minRating: String?, startYear: String?, endYear: String?, collection: String = "GratefulDead") -> String {
        ...
        // Fields
        let fields = "identifier,date,venue,transferer,source,coverage,stars,avg_rating,num_reviews,collection"
